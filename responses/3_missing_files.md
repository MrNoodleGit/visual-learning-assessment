...
Reflection: My first step is to investigate the issue and explore the most likely causes. My next priority is to offer Émile practical steps so they can move forward, which will be helpful regardless of the underlying issue. I also aim to offer whatever honest reassurance I can to alleviate unhelpful stress or anxiety about the problem. I share the most essential details about the cause of the issue so that Émile can have some insight, but it isn't my emphasis.
